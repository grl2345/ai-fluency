...
export const levels = [
  {
    ...
    description: { zh: '刚开始了解 AI 工具，缺乏使用经验', en: 'Just starting to explore AI tools, limited experience' },
    minScore: 0,
    maxScore: 20,
    color: 'bg-slate-500',
    badge: 'L1',
  },
  {
    ...
    description: { zh: '能使用 AI 完成基础任务，特定场景下有效', en: 'Can use AI for basic tasks, effective in specific scenarios' },
    minScore: 21,
    maxScore: 40,
    color: 'bg-teal-500',
    badge: 'L2',
  },
  {
    level: 3,
    internalTier: 3,
    name: { zh: 'AI 应用者', en: 'AI Prompter' },
    description: { zh: '能灵活运用 AI 工具，解决特定领域问题', en: 'Can flexibly use AI tools to solve domain-specific problems' },
    minScore: 41,
    maxScore: 60,
    color: 'bg-blue-500',
    badge: 'L3',
  },
  {
    level: 4,
    internalTier: 4,
    name: { zh: 'AI 熟练者', en: 'AI Collaborator' },
    description: { zh: '能优化 AI 使用流程，具备系统化应用能力', en: 'Can optimize AI workflows with systematic application ability' },
    minScore: 61,
    maxScore: 80,
    color: 'bg-amber-500',
    badge: 'L4',
  },
  {
    level: 5,
    internalTier: 5,
    name: { zh: 'AI 专家', en: 'AI Expert' },
    description: { zh: '能够设计 AI 解决方案，推动组织级应用', en: 'Can design AI solutions and drive organization-level adoption' },
    minScore: 81,
    maxScore: 100,
    color: 'bg-violet-600',
    badge: 'L5',
